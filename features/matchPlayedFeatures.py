...
class matchPlayedFeatures(Feature):
    ...
    a collection of documents in the format _id-> {'match': this.wyId, 'player' : player, 'name': 'minutesPlayed'|'teamName'|'goalScored'|'timestamp'},value: <float>|<string>;
    ...
    def createFeature(self,collectionName='minutesPlayedFeatures',param={},limit=None):
        ...
        print ("[matchPlayedFeatures] matches to be processed: ",db.matches.find(query).count())
